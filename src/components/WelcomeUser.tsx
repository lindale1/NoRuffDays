...
function WelcomeUser (){
    return (
        <section className="flex flex-col justify-center items-center px-6 py-40 leading-tight text-center whitespace-nowrap bg-blue-300 max-md:px-5 max-md:py-24">
